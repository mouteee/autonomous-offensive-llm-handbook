...
<!-- num-ok: one place is a spelled quantity counting a position in this handbook's own argument rather than anything in the code, which is what the sentence itself says it is -->
...
<!-- num-ok: three rows is a spelled quantity counting a code artifact: the three findings this section counts out of the run's reported false positives, each of them described individually above -->
...
<!-- num-ok: one line is a spelled quantity counting a code artifact: the single line of string handling this sentence names, in the bundle miner this repository withholds rather than in core/ -->

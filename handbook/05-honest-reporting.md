...
The layers carry the switches. `[[code:scheduler.py:AUTOMATOR_SCHEDULER_ENABLED]]` sits beside a fatigue switch and a category-budget switch in the scheduler's constructor, and they work. Off, the adjust pass hands the Layer 1 ranking straight back:

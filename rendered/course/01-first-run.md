...
A machine with a recent Python 3 and a clone of this repository. Nothing else. The optional local-model connection comes later, in [connect your model](../../docs/CONNECT_YOUR_MODEL.md); live network adapters are not part of this repository at all. [^num-1]
...
[^num-1]: 3 names the Python major version this repository targets, a toolchain identifier rather than a measurement
